    ...
    <div className="border border-gray-500 flex flex-col">
      ...
      <div className="flex-1  grid grid-rows-3 gap-2 p-1">
        <div className=" grid grid-cols-3 gap-2">
          ...
          <button className="flex justify-center items-center gap-1 bg-blue-500 text-white rounded-md cursor-pointer">
            <div>
              <FaPlay size={20} />
            </div>
            <div className="font-semibold">Start</div>
          </button>
          <button className="flex justify-center items-center gap-1 bg-green-500 text-white rounded-md cursor-pointer">
            <div>
        ...
        <div className=" grid grid-cols-3 gap-2">
          <button className="flex justify-center items-center bg-gray-500 text-white rounded-md cursor-pointer p-1">
